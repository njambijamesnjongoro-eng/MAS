...
APPOINTMENT_REMINDER_INLINE_MODE = env_bool("APPOINTMENT_REMINDER_INLINE_MODE", CELERY_TASK_ALWAYS_EAGER)
...
APPOINTMENT_CRON_SECRET = os.getenv("APPOINTMENT_CRON_SECRET", "")
